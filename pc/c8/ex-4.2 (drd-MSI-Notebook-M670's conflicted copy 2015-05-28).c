...
int main(void)
{
	...
	struct  date date_and_week[7] = {
	  							 { date_and_week[7].year, date_and_week[7].month, date_and_week[7].day, {'M','o','n','d', 'a', 'y'} },
	 							 { date_and_week[7].year, date_and_week[7].month, date_and_week[7].day,  {'T', 'u', 's','d', 'a', 'y'}},
	 							 { date_and_week[7].year, date_and_week[7].month, date_and_week[7].day, {'W','e', 'n', 's', 'd', 'e', 'a', 'y'} },
	 			 				 { date_and_week[7].year, date_and_week[7].month, date_and_week[7].day,  {'T', 'h', 'u', 'r', 'd', 'a', 'y'} },
	 							 { date_and_week[7].year, date_and_week[7].month, date_and_week[7].day, {'F', 'r', 'i', 'd', 'a', 'y'}},
	 			 				 { date_and_week[7].year, date_and_week[7].month, date_and_week[7].day, {'S', 'a', 't', 'u', 'r', 'd', 'a', 'y'}  },
	 			 				 { date_and_week[7].year, date_and_week[7].month, date_and_week[7].day, {'S', 'u', 'n', 'd', 'a', 'y'} }  
	 			               };
